...
import { getUserData, getEffectLibrary, getPedalboardLibrary, saveEffectToLibrary, removeEffectFromLibrary, savePedalboardToLibrary, removePedalboardFromLibrary } from '../controllers/me.controller'
...
router.delete('/pedalboards/:id', verifyToken, removePedalboardFromLibrary)
